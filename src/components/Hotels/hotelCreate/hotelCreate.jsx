                ...
                <form action="" method="POST" enctype="multipart/form-data" className="crate-hotel">
                    ...
                    <div className="create-hotel-top">
                        ...
                        <div className="create-hotel-top-1">
                            <input type="file" id="input-hotel-create" name="productFile" required></input>
                        ...
                        <div className="create-hotel-top-2">
                            ...
                            <section className="create-hotel-name-spot">
                                <div className="create-hotel-inputDiv">
                                    ...
                                    <input className="create-hotel-input" type="text" id="name" name="name"></input>
                                </div>
                                <div className="create-hotel-inputDiv">
                                    <label className="create-hotel-label" for="spot">Ubicacion:</label>
                                    <input className="create-hotel-input" type="text" id="spot" name="spot"></input>
                                </div>
                            </section>
                            ...
                            <section className="create-hotel-description">
                                <div className="create-hotel-inputDiv">
                                    ...
                                    <input className="create-hotel-input" type="textarea" name="descriptionH" id="descriptionH"></input>
                                </div>
                            </section>
                            ...
                            <section className="create-hotel-service ">
                                ...
                                <div className="create-hotel-inputDiv">
                                    ...
                                    <input className="create-hotel-input" type="number" name="price" id="price"></input>
                                </div>
                            </section>
