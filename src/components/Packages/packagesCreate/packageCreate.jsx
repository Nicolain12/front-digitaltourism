                                ...
                                <div className="form-pack-flight-top-2">
                                    ...
                                    <div className="form-pack-flight-top-2-div">
                                        <div className="form-pack-flight-inputDiv">
                                            ...
                                            <input className="form-pack-flight-input" type="text" id="airline" name="airline" placeholder="Aerolinea"></input>
                                        </div>
                                        <div className="form-pack-flight-inputDiv">
                                            <label className="form-pack-flight-label" for="descriptionF">Descripcion:</label>
                                            <input className="form-pack-flight-input" type="text" id="descriptionF"  name="descriptionF" placeholder="Descripcion"></input>
                                        </div>
                                    </div>
                                    ...
                                    <div className="form-pack-flight-top-2-div">
                                        <div className="form-pack-flight-inputDiv">
                                            ...
                                            <input className="form-pack-flight-input" type="text" id="departure" name="departure" placeholder="Origen"></input>
                                        </div>
                                        <div className="form-pack-flight-inputDiv">
                                            <label className="form-pack-flight-label" for="reach"><i
                                                className="fa-solid fa-location-dot"></i></label>
                                            <input className="form-pack-flight-input" type="text" id="reach" name="reach" placeholder="Destino"></input>
                                        </div>
                                    </div>
                                    ...
                                    <div className="form-pack-flight-top-2-div">
                                        <div className="form-pack-flight-inputDiv">
                                            <label className="form-pack-flight-label" for="departureDate">Fecha de
                                                ida</label>
                                            <input className="form-pack-flight-input" type="date" id="departureDate" name="departureDate"></input>
                                        </div>
                                        <div className="form-pack-flight-inputDiv">
                                            <label className="form-pack-flight-label" for="reachDate">Fecha de
                                                vuelta</label>
                                            <input className="form-pack-flight-input" type="date" id="reachDate" name="reachDate"></input>
                                        </div>
                                    </div>
                                    ...
                                    <div className="form-pack-flight-top-2-div">
                                        ...
                                        <div className="form-pack-flight-inputDiv">
                                            <label className="form-pack-flight-label" for="departureHour">Hora de
                                                salida</label>
                                            <input className="form-pack-flight-input" type="time" id="departureHour" name="departureHour"></input>
                                        </div>
                                        <div className="form-pack-flight-inputDiv">
                                            <label className="form-pack-flight-label" for="reachHour">Hora de
                                                llegada</label>
                                            <input className="form-pack-flight-input" type="time" id="reachHour" name="reachHour"></input>
                                        </div>
                                    ...
                                    <div className="form-pack-flight-top-2-div">
                                        ...
                                        <div className="form-pack-flight-inputDiv">
                                            <label className="form-pack-flight-label" for="priceF">Precio:</label>
                                            <input className="form-pack-flight-input" type="number" id="priceF" name="priceF"></input>
                                        </div>
                                ...
                                <div className="pack-hotel-top-2">
                                    ...
                                    <section className="pack-hotel-name-spot">
                                        <div className="pack-hotel-inputDiv">
                                            ...
                                            <input className="pack-hotel-input" type="text" id="name" name="name"></input>
                                        </div>
                                        <div className="pack-hotel-inputDiv">
                                            <label className="pack-hotel-label" for="spot">Ubicacion:</label>
                                            <input className="pack-hotel-input" type="text" id="spot" name="spot"></input>
                                        </div>
                                    </section>
                                    ...
                                    <section className="pack-hotel-description">
                                        <div className="pack-hotel-inputDiv">
                                            <label className="pack-hotel-label" for="descriptionH">Agregue una
                                                descripcion:</label>
                                            <input className="pack-hotel-input" type="textarea" name="descriptionH" id="descriptionH"></input>
                                        </div>
                                    </section>
                                    ...
                                    <section className="pack-hotel-service ">
                                        ...
                                        <div className="pack-hotel-inputDiv">
                                            <label className="pack-hotel-label" for="priceH">Precio por noche:</label>
                                            <input className="pack-hotel-input" type="number" name="priceH" id="priceH"></input>
                                        </div>
                                    </section>
